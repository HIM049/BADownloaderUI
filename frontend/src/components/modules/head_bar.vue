    ...
    <header>
        <nav style="--wails-draggable:drag; display:flex; justify-content:space-between; margin: 0px 0px 0px 13px;">
            <div id="logo" style=" display:flex; align-items:center; ">
                <div style=" background: rgb(255, 255, 255); border-radius: 16px; padding: 8px; display: flex;">
                ...
                <div style="display:flex; font-size:20px; font-weight:800; margin-left:10px;">
                    <p style="color: var(--color-primary-font);">B</p>
                    <p>ili</p>
                    <p style="color: var(--color-primary-font);">A</p>
                    <p>udio</p>
                    <p style="color: var(--color-primary-font);">D</p>
                    <p>ownloader</p>
                    <var-chip color="var(--color-body)" text-color="var(--color-text)" size="mini" style="margin-top: 10px;">{{ APP_VERSION }}</var-chip>
                    <!-- <p style="font-size: 12px; display: flex; padding-left: 10px; align-items: center;"></p> -->
                </div>
            </div>
